...
#define GEQO2_GUC_HOOK_VALUES NULL, NULL, NULL
#else
#define GEQO2_GUC_HOOK_VALUES NULL, NULL
#endif
...
//extern
RelOptInfo *geqo_extension(PlannerInfo *root, int number_of_rels, List *initial_rels);
