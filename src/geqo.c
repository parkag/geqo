...
#include "geqo_misc.h"
#include "geqo_mutation.h"
#include "geqo_pool.h"
#include "geqo_random.h"
#include "geqo_selection.h"
#include "geqo.h"
...
RelOptInfo *
geqo_extension(PlannerInfo *root, int number_of_rels, List *initial_rels)
{
	Geqo2PrivateData private;
	int			generation;
	Chromosome *momma;
	Chromosome *daddy;
	Chromosome *kid;
